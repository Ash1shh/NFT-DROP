    ...
    <div className="flex flex-col h-screen lg:grid lg:grid-cols-10">
      ...
      <div className="lg:col-span-4 bg-gradient-to-br from-cyan-800 to-rose-500">
        <div className="flex flex-col items-center justify-center py-2 lg:min-h-screen">
          ...
          <div className="space-y-2 text-center p-5">
            <h1 className="text-4xl fond-bold text-white">
            ...
            <h2 className="text-xl text-gray-300">
              A non-fungible token is a financial security consisting of digital
              data stored in a blockchain, a form of distributed ledger. The
      ...
      <div className="flex flex-col flex-1 lg:col-span-6 p-12">
        ...
        <header className="items-center justify-between flex">
          <Link href={"/"}>
            <h1 className="w-52 cursor-pointer font-extralight text-xl sm:w-80">
              THE{" "}
        ...
        <div className="mt-10 flex flex-1 flex-col items-center text-center space-y-6 lg:space-y-0 lg:justify-center">
          ...
          {loading && (
            <img
              ...
              src="https://miro.medium.com/max/1838/1*CsJ05WEGfunYMLGfsT2sXA.gif"
              alt=""
            />
          )}
        </div>
